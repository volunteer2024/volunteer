...
<head>
    ...
    <title>School Admin- Admin Panel</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="manage_students.php">Students Managment</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="volunteer_organizations.php">Volunteer Organizations</a>
                    </li>
